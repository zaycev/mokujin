...
"""
This scrips generates term-pattern matrix from the set of found sources generated by script findsources.py

Usage:
    python gensourcematrix.py -d triples-index-dir -i sources.pkl
"""
